...
import { suffixInflection, type LanguageTransformDescriptor } from './language-transformer';
...
function irregularVerbSuffixInflections(
    ...
    const inflections: ReturnType<typeof suffixInflection<Condition>>[] = [];
...
export type JapaneseCondition = keyof typeof conditions;

export const japaneseTransforms: LanguageTransformDescriptor<JapaneseCondition> = {
    language: 'ja',
    conditions,
    transforms: {
        '-ば': {
